        ...
        <Flex height="100vh" direction="column">
          ...
          >
            ...
            <UnorderedList display="flex" alignItems="center" justifyContent="center" gap="40px">
              ...
              <Button as="a" href="https://heazy-svg-creator-maximbuz.vercel.app/" rounded="full" _hover={{ bg: '#05f', color: 'white' }}>
                Try it out!
              </Button>
            </UnorderedList>
          </Flex>
          ...
          <Flex mt="-80px" height="100%" justifyContent="space-between" alignItems="center" wrap="wrap">
            <Flex direction="column" gap="20px">
              ...
              <Flex alignItems="center" gap="15px">
                <Button as="a" href="https://heazy-svg-creator-maximbuz.vercel.app/" rounded="full" size="lg" _hover={{ bg: '#05f', color: 'white' }}>
                  Start Designing
                </Button>
                <Text>
